...
type User struct {
	...
	// PromptAuditBypass holds the value of the "prompt_audit_bypass" field.
	PromptAuditBypass bool `json:"prompt_audit_bypass,omitempty"`
...
func (*User) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		switch columns[i] {
		case user.FieldTotpEnabled, user.FieldRestrictPublicGroups, user.FieldBalanceNotifyEnabled, user.FieldPromptAuditBypass:
...
func (_m *User) assignValues(columns []string, values []any) error {
	...
	for i := range columns {
		...
		case user.FieldPromptAuditBypass:
			if value, ok := values[i].(*sql.NullBool); !ok {
				return fmt.Errorf("unexpected type %T for field prompt_audit_bypass", values[i])
			} else if value.Valid {
				_m.PromptAuditBypass = value.Bool
			}
		default:
...
func (_m *User) String() string {
	...
	builder.WriteString(", ")
	builder.WriteString("prompt_audit_bypass=")
	builder.WriteString(fmt.Sprintf("%v", _m.PromptAuditBypass))
	builder.WriteByte(')')
