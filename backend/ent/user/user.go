...
const (
	...
	// FieldPromptAuditBypass holds the string denoting the prompt_audit_bypass field in the database.
	FieldPromptAuditBypass = "prompt_audit_bypass"
...
var (
	...
	DefaultRpmLimit int
	// DefaultPromptAuditBypass holds the default value on creation for the "prompt_audit_bypass" field.
	DefaultPromptAuditBypass bool
)
...
// ByPromptAuditBypass orders the results by the prompt_audit_bypass field.
func ByPromptAuditBypass(opts ...sql.OrderTermOption) OrderOption {
	return sql.OrderByField(FieldPromptAuditBypass, opts...).ToFunc()
}
