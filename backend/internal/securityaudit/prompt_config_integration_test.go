...
func promptAuditUpdateRequest(version int64, workerCount int, token string) UpdateConfigRequest {
	return UpdateConfigRequest{
		...
		Strategy: "priority", WorkerCount: workerCount, PromptChunkConcurrency: promptChunkConcurrencyPtr(DefaultPromptChunkConcurrency), QueueCapacity: 64, Scanners: []string{"pii", "jailbreak"},
		AllGroups: true, Endpoints: []UpdateEndpoint{{
			ID: "guard-one", Name: "Guard One", Protocol: "openai_compatible",
			BaseURL: "http://cpa:8317", Model: "", Token: token,
